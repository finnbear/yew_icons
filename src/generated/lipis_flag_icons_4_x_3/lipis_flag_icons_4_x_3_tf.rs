use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_tf (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-tf" viewBox = "0 0 640 480" > < defs > { "
  ...
  " } < use href = "#a" width = "100%" height = "100%" x = "416" y = "362" transform = "scale(1.2)" /> { "
  " } < use href = "#a" width = "100%" height = "100%" x = "371" y = "328" transform = "scale(1.2)" /> { "
  " } < use href = "#a" width = "100%" height = "100%" x = "461" y = "328" transform = "scale(1.2)" /> { "
  " } < use href = "#a" width = "100%" height = "100%" x = "333" y = "227" transform = "scale(1.2)" /> { "
  " } < use href = "#a" width = "100%" height = "100%" x = "499" y = "227" transform = "scale(1.2)" /> </ svg > } }