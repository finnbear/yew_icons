use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_cefta (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-cefta" version = "1.1" viewBox = "0 0 640 480" > < path id = "rect598" d = "M0 0h640v480H0z" style = "fill:#039;stroke-width:2.05565" /> { "
  ...
  " } < path id = "rect625" d = "M35.8 548.4h27.5v27.5H35.8z" style = "fill:#fc0;stroke-width:1.96319" transform = "rotate(-45)" /> </ svg > } }