use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_ly (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ly" viewBox = "0 0 640 480" > < defs > { "
    " } < clipPath id = "ly-a" > { "
      " } < path d = "M166.7-20h666.6v500H166.7z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g transform = "matrix(.96 0 0 .96 -160 19.2)" > { "
