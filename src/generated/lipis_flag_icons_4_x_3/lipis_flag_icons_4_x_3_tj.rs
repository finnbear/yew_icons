use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_tj (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-tj" viewBox = "0 0 640 480" > < path fill = "#060" d = "M0 0h640v480H0z" /> { "
  ...
  " } < use href = "#a" width = "100%" height = "100%" fill = "#f8c300" transform = "matrix(-1 0 0 1 640 0)" /> { "
  ...
  " } < use href = "#b" width = "100%" height = "100%" fill = "#f8c300" transform = "rotate(9.4 320 551.3)" /> { "
  " } < use href = "#b" width = "100%" height = "100%" fill = "#f8c300" transform = "rotate(18.7 320 551.3)" /> { "
  ...
  " } < g id = "d" fill = "#f8c300" transform = "translate(320 260.6) scale(.68571)" > { "
    " } < use href = "#c" width = "100%" height = "100%" transform = "translate(-70 -121.2)" /> { "
    " } < use href = "#c" width = "100%" height = "100%" transform = "translate(-121.2 -70)" /> { "
    " } < use href = "#c" width = "100%" height = "100%" transform = "translate(-140)" /> { "
  " } </ g > { "
  " } < use href = "#d" width = "100%" height = "100%" fill = "#f8c300" transform = "matrix(-1 0 0 1 640 0)" /> </ svg > } }