use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_es_ga (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-es-ga" version = "1.0" viewBox = "0 0 640 480" > < g id = "g5162" font - size = "12" transform = "matrix(1.06667 0 0 1.2001 0 -115.3)" > { "
