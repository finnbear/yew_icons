use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_ms (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ms" viewBox = "0 0 640 480" > < path id = "rect950" fill = "#012169" stroke - width = ".7" d = "M0 0h640v480H0z" opacity = "1" stop - opacity = "1" /> { "
  ...
  " } < path id = "path1754" fill = "#C8102E" stroke - width = ".5" d = "M0 96.5v48h320v-48zM136.5 0v240h48V0z" opacity = "1" stop - opacity = "1" /> </ svg > } }