use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_gd (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-gd" viewBox = "0 0 640 480" > < defs > { "
    " } < g id = "c" > { "
      " } < g id = "b" > { "
  ...
  " } < use href = "#c" width = "100%" height = "100%" transform = "matrix(52.8 0 0 52.8 320 240)" /> { "
  " } < use href = "#d" width = "100%" height = "100%" x = "-100" transform = "translate(-30.3)" /> { "
  " } < use href = "#c" id = "d" width = "100%" height = "100%" transform = "matrix(31.2 0 0 31.2 320 33.6)" /> { "
  " } < use href = "#d" width = "100%" height = "100%" x = "100" transform = "translate(30.3)" /> { "
  ...
  " } < use href = "#d" width = "100%" height = "100%" x = "-100" transform = "translate(-30.3 414.6)" /> { "
  " } < use href = "#c" width = "100%" height = "100%" transform = "matrix(31.2 0 0 31.2 320 448.2)" /> { "
  " } < use href = "#d" width = "100%" height = "100%" x = "100" transform = "translate(30.3 414.6)" /> </ svg > } }