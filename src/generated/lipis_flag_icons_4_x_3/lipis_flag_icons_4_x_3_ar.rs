use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_ar (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ar" version = "1.1" viewBox = "0 0 640 480" > < path id = "rect478" fill = "#74acdf" d = "M0 0h640v480H0z" style = "stroke-width:.876356" /> { "
  ...
  " } </ g > { "
  " } < use href = "#rays" id = "use497" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(90 320 240)" /> { "
  " } < use href = "#rays" id = "use499" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(180 320 240)" /> { "
  " } < use href = "#rays" id = "use501" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(-90 320 240)" /> { "
  ...
  " } < use href = "#uppalpebra" id = "use506" width = "100%" height = "100%" x = "0" y = "0" transform = "matrix(-1 0 0 1 640.2 0)" /> { "
  " } < use href = "#eyebrow_nose" id = "use508" width = "100%" height = "100%" x = "0" y = "0" transform = "matrix(-1 0 0 1 640.2 0)" /> { "
  " } < use href = "#pupil" id = "use510" width = "100%" height = "100%" x = "0" y = "0" transform = "translate(18.1)" /> { "
  " } < use href = "#lowpalpebra" id = "use512" width = "100%" height = "100%" x = "0" y = "0" transform = "matrix(-1 0 0 1 640.2 0)" /> { "
  ...
  " } < use href = "#loweyecontour" id = "use526" width = "100%" height = "100%" x = "0" y = "0" transform = "translate(-18.4)" /> { "
  " } < circle id = "pupil" cx = "310.9" cy = "236.3" r = "1.8" fill = "#85340a" style = "stroke-width:.96" /> { "
  " } < path id = "lowpalpebra" fill = "#85340a" d = "M305.9 237.5c3.5 2.7 7 2.5 9 1.3 2-1.3 2-1.7 1.6-1.7-.4 0-.8.4-2.4 1.3-1.7.8-4.1.8-8.2-.9z" style = "stroke-width:.96" /> </ svg > } }