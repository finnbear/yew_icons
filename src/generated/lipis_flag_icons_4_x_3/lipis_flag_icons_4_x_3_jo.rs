use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_jo (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-jo" viewBox = "0 0 640 480" > < defs > { "
    " } < clipPath id = "jo-a" > { "
      " } < path fill - opacity = ".7" d = "M-117.8 0h682.6v512h-682.6z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g transform = "translate(110.5) scale(.9375)" > { "
