use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_ai (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ai" viewBox = "0 0 640 480" > < defs id = "defs1837" > { "
    " } < clipPath id = "ai-a" > { "
  ...
  " } < path id = "path5296" fill = "#c8102e" stroke - width = ".5" d = "M0 96.5v48h320v-48zM136.5 0v240h48V0z" /> </ svg > } }