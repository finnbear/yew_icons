use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_vg (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-vg" viewBox = "0 0 640 480" > < defs id = "defs1705" > { "
    " } < linearGradient id = "a" > { "
      " } < stop id = "stop1685" offset = "0" stop - color = "red" /> { "
      " } < stop id = "stop1687" offset = "1" stop - color = "#ff0" /> { "
    " } </ linearGradient > { "
    " } < linearGradient href = "#a" id = "c" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 191.4 180)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "d" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 190.8 144)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "e" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 317.4 111.1)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "f" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 193.8 76.1)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "g" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 194 41.6)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "h" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 194.6 6.7)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "i" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 318.4 7.2)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "j" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 317.3 41.5)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "k" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 315.7 76.7)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "l" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85004 0 0 1.92222 317.3 180.4)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "m" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 317.1 145.6)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "n" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85002 0 0 1.92212 216.4 113.5)" gradientUnits = "userSpaceOnUse" /> { "
