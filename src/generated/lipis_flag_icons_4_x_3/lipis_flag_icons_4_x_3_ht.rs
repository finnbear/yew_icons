use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_ht (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ht" viewBox = "0 0 640 480" > < path fill = "#d21034" d = "M0 0h640v480H0z" /> { "
  ...
  " } < g fill = "#f1b517" stroke = "#000" stroke - width = ".2" > { "
    ...
    " } < g transform = "translate(-80) scale(1.6)" > { "
      ...
      " } </ g > { "
      " } < use href = "#a" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 499.9 0)" /> { "
    " } </ g > { "
    " } < g transform = "translate(-80) scale(1.6)" > { "
      ...
      " } </ g > { "
      " } < use href = "#b" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 499.9 0)" /> { "
    ...
    " } </ g > { "
    " } < g transform = "translate(-80) scale(1.6)" > { "
      " } < use href = "#c" width = "100%" height = "100%" transform = "matrix(1 0 0 -1 0 320.4)" /> { "
      ...
      " } </ g > { "
      " } < use href = "#d" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 499.9 0)" /> { "
