use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_sv (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-sv" viewBox = "0 0 640 480" > < path fill = "#0f47af" d = "M0 0h640v480H0z" /> { "
  ...
  " } < g transform = "matrix(.8 0 0 .8 -92.7 0)" > { "
    ...
    " } < g id = "a" stroke = "#000" stroke - miterlimit = "2.6" > { "
      ...
      " } </ g > { "
    " } </ g > { "
    " } < use href = "#a" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 1030 0)" /> { "
  ...
  " } < g transform = "matrix(.8 0 0 .8 -92.7 0)" > { "
    ...
    " } </ g > { "
    " } < use href = "#b" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 1030 0)" /> { "
    ...
    " } < g id = "c" > { "
      ...
      " } </ g > { "
    " } </ g > { "
    " } < use href = "#c" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 1030 0)" /> { "
  " } </ g > { "
