use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_tc (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-tc" version = "1.1" viewBox = "0 0 640 480" > < path id = "path314" fill = "#006" d = "M640 480V0H0v480h640z" style = "fill:#002868;fill-opacity:1" /> { "
  ...
  " } < path id = "path227" fill = "#c8102e" d = "M0 96.5v48h320v-48zM136.5 0v240h48V0Z" style = "stroke-width:.5" /> </ svg > } }