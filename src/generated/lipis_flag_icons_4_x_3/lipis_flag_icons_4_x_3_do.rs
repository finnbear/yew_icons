use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_do (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-do" viewBox = "0 0 640 480" > < defs > { "
    " } < clipPath id = "do-a" > { "
      " } < path fill - opacity = ".7" d = "M-222.6-115.2h958v718.4h-958z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g transform = "matrix(.67 0 0 .67 148.7 77)" > { "
