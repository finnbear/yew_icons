use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_4_x_3_ky (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ky" version = "1.1" viewBox = "0 0 640 480" > < path id = "path6183" fill = "#006" d = "M0 0h640v480H0z" /> { "
  ...
  " } < g id = "border" stroke = "#fff" stroke - linejoin = "round" stroke - width = "9.6" transform = "translate(-306.8 -21.2) scale(.87136)" > { "
    " } < use href = "#shield" id = "use1093" width = "100%" height = "100%" x = "0" y = "0" /> { "
    " } < use href = "#motto1" id = "use1095" width = "100%" height = "100%" x = "0" y = "0" /> { "
    " } < use href = "#motto2" id = "use1097" width = "100%" height = "100%" x = "0" y = "0" /> { "
    " } < use href = "#rope" id = "use1099" width = "100%" height = "100%" x = "0" y = "0" /> { "
    " } < use href = "#turtle" id = "use1101" width = "100%" height = "100%" x = "0" y = "0" /> { "
    " } < use href = "#pineapple1" id = "use1103" width = "100%" height = "100%" x = "0" y = "0" /> { "
    " } < use href = "#pineapple2" id = "use1105" width = "100%" height = "100%" x = "0" y = "0" /> { "
  " } </ g > { "
  ...
  " } < g id = "g1475" stroke = "none" style = "stroke-width:1.4" transform = "translate(-306.8 -21.2) scale(.87136)" > { "
    ...
    " } </ g > { "
    " } < use href = "#star" id = "use1469" width = "100%" height = "100%" x = "90.1" y = "0" /> { "
    " } < use href = "#star" id = "use1471" width = "100%" height = "100%" x = "45" y = "52.2" /> { "
