use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_vg (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-vg" viewBox = "0 0 512 512" > < defs id = "defs4389" > { "
    " } < linearGradient id = "a" > { "
      " } < stop id = "stop4369" offset = "0" stop - color = "red" /> { "
      " } < stop id = "stop4371" offset = "1" stop - color = "#ff0" /> { "
    " } </ linearGradient > { "
    " } < linearGradient href = "#a" id = "c" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 191.3 180)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "d" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 190.6 143.9)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "e" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 317.4 111.1)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "f" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 193.6 76.1)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "g" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 194 41.7)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "h" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 194.6 6.6)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "i" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 318.4 7.2)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "j" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 317.2 41.6)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "k" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 315.7 76.7)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "m" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 317.1 145.7)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "n" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85005 0 0 1.92216 216.3 113.3)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "l" x1 = "103.1" x2 = "92.5" y1 = "111.3" y2 = "107.8" gradientTransform = "matrix(.85004 0 0 1.9222 317.3 180.4)" gradientUnits = "userSpaceOnUse" /> { "
  ...
  " } < g id = "g1028" transform = "translate(-282.6 18.3) scale(.73883)" > { "
    ...
    " } </ g > { "
    " } < use href = "#lamp" id = "use874" width = "100%" height = "100%" x = "-.8" y = "41.3" /> { "
    " } < use href = "#lamp" id = "use876" width = "100%" height = "100%" x = "-1.1" y = "82" /> { "
    " } < use href = "#lamp" id = "use878" width = "100%" height = "100%" x = "25.6" y = "126.1" /> { "
    " } < use href = "#lamp" id = "use880" width = "100%" height = "100%" x = "-4.6" y = "162.2" /> { "
    " } < use href = "#lamp" id = "use882" width = "100%" height = "100%" x = "-3.8" y = "204.8" /> { "
    " } < use href = "#lamp" id = "use884" width = "100%" height = "100%" x = "146.3" y = ".7" /> { "
    " } < use href = "#lamp" id = "use886" width = "100%" height = "100%" x = "144.9" y = "41.2" /> { "
    " } < use href = "#lamp" id = "use888" width = "100%" height = "100%" x = "143.1" y = "82.7" /> { "
    " } < use href = "#lamp" id = "use890" width = "100%" height = "100%" x = "145.2" y = "123.4" /> { "
    " } < use href = "#lamp" id = "use892" width = "100%" height = "100%" x = "144.7" y = "164.2" /> { "
    " } < use href = "#lamp" id = "use894" width = "100%" height = "100%" x = "144.9" y = "205.2" /> { "
  ...
  " } < path id = "path5741" fill = "#c8102e" d = "M0 104v48h256v-48ZM104 0v256h48V0Z" style = "stroke-width:.5" /> </ svg > } }