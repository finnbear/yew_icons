use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_za (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-za" viewBox = "0 0 512 512" > < defs > { "
    " } < clipPath id = "za-a" > { "
      " } < path fill - opacity = ".7" d = "M70.1 0h499.6v499.6H70.1z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g transform = "translate(-71.9) scale(1.0248)" > { "
