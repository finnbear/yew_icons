use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_pg (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } id = "flag-icons-pg" viewBox = "0 0 512 512" > < defs > { "
    " } < clipPath id = "pg-a" > { "
      " } < path fill - opacity = ".7" d = "M81.4 0h496v496h-496z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g transform = "translate(-84) scale(1.0321)" > { "
    " } < g fill - rule = "evenodd" > { "
