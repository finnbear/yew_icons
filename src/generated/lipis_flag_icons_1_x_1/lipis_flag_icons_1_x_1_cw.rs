use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_cw (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-cw" viewBox = "0 0 512 512" > < defs > { "
    " } < clipPath id = "cw-a" > { "
  ...
  " } < g clip - path = "url(#cw-a)" transform = "scale(.057)" > { "
    ...
    " } < use href = "#b" width = "13500" height = "9000" x = "3" y = "3" fill = "#fff" transform = "scale(1000)" /> { "
  " } </ g > </ svg > } }