use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_ni (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ni" viewBox = "0 0 512 512" > < defs > { "
    ...
    " } </ linearGradient > { "
    " } < linearGradient href = "#a" id = "h" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#b" id = "v" x1 = "484.8" x2 = "484.8" y1 = "311.7" y2 = "317.6" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "o" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "p" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "q" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "r" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#b" id = "u" x1 = "484.8" x2 = "484.8" y1 = "311.7" y2 = "317.6" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "x" x1 = "98.9" x2 = "125" y1 = "1440.2" y2 = "1440.2" gradientTransform = "scale(4.45715 .22436)" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "j" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "l" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "m" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "i" x1 = "444.5" x2 = "634.4" y1 = "317.5" y2 = "317.5" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#b" id = "s" x1 = "484.8" x2 = "484.8" y1 = "311.7" y2 = "317.6" gradientUnits = "userSpaceOnUse" /> { "
    " } < linearGradient href = "#a" id = "y" x1 = "47.9" x2 = "61.7" y1 = "3054.2" y2 = "3054.2" gradientTransform = "scale(9.12405 .1096)" gradientUnits = "userSpaceOnUse" /> { "
    " } < clipPath id = "ni-c" > { "
  ...
  " } < g transform = "translate(-170.7) scale(.85333)" > { "
    ...
    " } < g id = "e" > { "
      ...
      " } </ g > { "
      " } < use href = "#d" width = "100%" height = "100%" transform = "rotate(72 500 285.5)" /> { "
      " } < use href = "#d" width = "100%" height = "100%" transform = "rotate(144 500 285.5)" /> { "
      " } < use href = "#d" width = "100%" height = "100%" transform = "rotate(-144 500 285.5)" /> { "
      " } < use href = "#d" width = "100%" height = "100%" transform = "rotate(-72 500 285.5)" /> { "
    " } </ g > { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(8 500 285.5)" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(16 500 285.5)" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(24 500 285.5)" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(32 500 285.5)" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(40 500 285.5)" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(48 500 285.5)" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(56 500 285.5)" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "rotate(64 500 285.5)" /> { "
    ...
    " } < g fill = "url(#h)" > { "
      ...
      " } < g id = "n" fill = "url(#i)" > { "
        ...
        " } < use href = "#k" width = "100%" height = "100%" y = "-1.1" fill = "url(#l)" /> { "
        " } < use href = "#k" width = "100%" height = "100%" y = "-2.2" fill = "url(#m)" /> { "
      " } </ g > { "
      " } < use href = "#n" width = "100%" height = "100%" y = "-3.3" fill = "url(#o)" /> { "
      " } < use href = "#n" width = "100%" height = "100%" y = "-6.7" fill = "url(#p)" /> { "
    ...
    " } < g fill = "#ccd11e" > { "
      ...
      " } </ g > { "
      " } < use href = "#t" width = "100%" height = "100%" x = "-15.3" /> { "
      " } < g fill = "#c6cb24" > { "
      ...
      " } </ g > { "
      " } < use href = "#w" width = "100%" height = "100%" x = "-15.4" fill = "#c6cb24" /> { "
    " } </ g > { "
    ...
    " } < g id = "A" > { "
      ...
      " } < use href = "#z" width = "100%" height = "100%" y = "-1.3" /> { "
      " } < use href = "#z" width = "100%" height = "100%" y = "-2.6" /> { "
    " } </ g > { "
    " } < use href = "#A" width = "100%" height = "100%" y = "-3.9" /> { "
    " } < use href = "#A" width = "100%" height = "100%" y = "-7.7" /> { "
  ...
  " } </ g > { "
  " } < path fill = "#c8a400" d = "m256 191.9-27.4 47.5-28 48.6h110.8L284 240.5l-28-48.6zm0 2.5 27 46.7 26.3 45.6H202.8l26.9-46.6z" /> </ svg > } }