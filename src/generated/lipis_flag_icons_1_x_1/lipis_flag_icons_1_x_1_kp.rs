use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_kp (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-kp" viewBox = "0 0 512 512" > < defs > { "
    " } < clipPath id = "kp-a" > { "
      " } < path fill - opacity = ".7" d = "M92.2 7.8h593.6v485.5H92.2z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g fill - rule = "evenodd" transform = "matrix(.86254 0 0 1.0546 -79.5 -8.3)" > { "
