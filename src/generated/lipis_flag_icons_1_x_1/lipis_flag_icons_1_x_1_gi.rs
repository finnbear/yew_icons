use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_gi (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-gi" viewBox = "0 0 512 512" > < path fill = "#da000c" d = "M0 0h512v512H0z" /> { "
  ...
  " } < g stroke = "#000" transform = "matrix(2 0 0 2 -256 0)" > { "
    ...
    " } </ g > { "
    " } < use href = "#a" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 512 0)" /> { "
    " } < g fill = "#f8d80e" > { "
