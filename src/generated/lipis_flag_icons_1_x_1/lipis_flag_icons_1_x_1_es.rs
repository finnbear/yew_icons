use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_es (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-es" viewBox = "0 0 512 512" > < path fill = "#AA151B" d = "M0 0h512v512H0z" /> { "
  ...
  " } < path fill = "none" stroke = "#000" stroke - width = "0" d = "M333.7 231.5v-1.2m-.6 1.3v-1.3m-.5 1.3v-1.3" /> </ svg > } }