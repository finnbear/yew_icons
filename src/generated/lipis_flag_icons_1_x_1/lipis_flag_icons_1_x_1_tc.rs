use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_tc (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-tc" version = "1.1" viewBox = "0 0 512 512" > < path id = "path314" fill = "#006" d = "M512 512V0H0v512z" style = "fill:#002868;fill-opacity:1;stroke-width:.92376" /> { "
      ...
      " } < g id = "g65" fill = "#9e540a" transform = "translate(400 -400)" > { "
        " } < g id = "L1" > { "
          ...
          " } < g id = "g47" stroke = "none" > { "
            " } < use href = "#ant" id = "use44" width = "100%" height = "100%" x = "0" y = "0" stroke = "#fcd116" stroke - width = "12" /> { "
        ...
        " } </ g > { "
        " } < use href = "#L1" id = "use56" width = "100%" height = "100%" x = "0" y = "0" transform = "scale(-1 1)" /> { "
        " } < g id = "L2" > { "
        ...
        " } </ g > { "
        " } < use href = "#L2" id = "use63" width = "100%" height = "100%" x = "0" y = "0" transform = "scale(-1 1)" /> { "
      " } </ g > { "
      " } < g id = "g86" > { "
        " } < g id = "L3" > { "
        ...
        " } </ g > { "
        " } < use href = "#L3" id = "use72" width = "100%" height = "100%" x = "0" y = "0" transform = "scale(-1 1)" /> { "
  ...
  " } < path id = "path3209" fill = "#c8102e" d = "M0 103.5v48h256v-48zM104-.5v256h48V-.5z" style = "stroke-width:.5" /> </ svg > } }