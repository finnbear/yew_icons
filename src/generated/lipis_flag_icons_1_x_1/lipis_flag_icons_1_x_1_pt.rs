use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_pt (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-pt" viewBox = "0 0 512 512" > < path fill = "red" d = "M204.8 0H512v512H204.7z" /> { "
  ...
  " } < g transform = "translate(-68.3 28.4) scale(1.13778)" > { "
    ...
    " } < g id = "e" > { "
      " } < g id = "d" fill = "#ff0" stroke = "#000" stroke - width = ".5" > { "
        ...
        " } < use href = "#a" width = "100%" height = "100%" x = "10.6" /> { "
        " } < path id = "b" d = "M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.3a.6.6 0 0 1-.6-.6v-2z" /> { "
        " } < use href = "#b" width = "100%" height = "100%" x = "10.6" /> { "
        " } < path fill = "#000" stroke = "none" d = "M193.9 140.6c0-.6.9-.6.9 0v1.6h-.9v-1.6" /> { "
        " } < path id = "c" fill = "#000" stroke = "none" d = "M188.6 142.8c0-.6.8-.6.8 0v1.2h-.8v-1.2" /> { "
        " } < use href = "#c" width = "100%" height = "100%" x = "10.6" /> { "
      " } </ g > { "
      " } < use href = "#d" width = "100%" height = "100%" y = "46.3" /> { "
      " } < use href = "#d" width = "100%" height = "100%" transform = "rotate(-45.2 312.8 180)" /> { "
    " } </ g > { "
    " } < use href = "#d" width = "100%" height = "100%" x = "45.7" /> { "
    " } < use href = "#e" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 479.8 0)" /> { "
    " } < g id = "f" fill = "#fff" > { "
    ...
    " } </ g > { "
    " } < use href = "#f" width = "100%" height = "100%" y = "-26" /> { "
    " } < use href = "#f" width = "100%" height = "100%" x = "-20.8" /> { "
    " } < use href = "#f" width = "100%" height = "100%" x = "20.8" /> { "
    " } < use href = "#f" width = "100%" height = "100%" y = "25.8" /> { "
  " } </ g > </ svg > } }