use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_gr (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-gr" viewBox = "0 0 512 512" > < path fill = "#005bae" fill - rule = "evenodd" stroke - width = ".8" d = "M0 0h512v57H0z" /> { "
  ...
  " } </ g > { "
  " } < path fill = "#005bae" fill - rule = "evenodd" stroke - width = ".8" d = "M0 455h512v57H0z" /> </ svg > } }