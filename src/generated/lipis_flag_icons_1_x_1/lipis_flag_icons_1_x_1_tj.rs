use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_tj (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-tj" viewBox = "0 0 512 512" > < path fill = "#060" d = "M0 0h512v512H0z" /> { "
  ...
  " } < g fill = "#f8c300" transform = "translate(-256) scale(.73143)" > { "
    ...
    " } < use href = "#a" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 1400 0)" /> { "
    ...
    " } < use href = "#b" width = "100%" height = "100%" transform = "rotate(9.4 700 804)" /> { "
    " } < use href = "#b" width = "100%" height = "100%" transform = "rotate(18.7 700 804)" /> { "
    ...
    " } < g transform = "translate(700 380)" > { "
      ...
      " } </ g > { "
      " } < use href = "#d" width = "100%" height = "100%" transform = "scale(-1 1)" /> { "
    " } </ g > { "
  " } </ g > </ svg > } }