use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_ar (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ar" version = "1.1" viewBox = "0 0 512 512" > < path id = "rect478" fill = "#74acdf" d = "M0 0h512v512H0z" style = "stroke-width:.809543" /> { "
  " } < path id = "rect480" fill = "#fff" d = "M0 170.7h512v170.7H0z" style = "stroke-width:.809543" /> { "
  " } < g id = "rays" transform = "translate(-153.6) scale(1.024)" > { "
    ...
    " } < use href = "#ray1" id = "use483" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(22.5 400 250)" /> { "
    " } < use href = "#ray1" id = "use485" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(45 400 250)" /> { "
    " } < use href = "#ray1" id = "use487" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(67.5 400 250)" /> { "
    " } < path id = "ray2" fill = "#85340a" d = "M404.3 274.4c.5 9 5.6 13 4.6 21.3 2.2-6.5-3.1-11.6-2.8-21.2m-7.7-23.8 19.5 42.6-16.3-43.9" /> { "
    " } < use href = "#ray2" id = "use490" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(22.5 400 250)" /> { "
    " } < use href = "#ray2" id = "use492" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(45 400 250)" /> { "
    " } < use href = "#ray2" id = "use494" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(67.5 400 250)" /> { "
  " } </ g > { "
  " } < use href = "#rays" id = "use497" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(90 256 256)" /> { "
  " } < use href = "#rays" id = "use499" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(180 256 256)" /> { "
  " } < use href = "#rays" id = "use501" width = "100%" height = "100%" x = "0" y = "0" transform = "rotate(-90 256 256)" /> { "
  ...
  " } < use href = "#uppalpebra" id = "use506" width = "100%" height = "100%" x = "0" y = "0" transform = "matrix(-1 0 0 1 512.3 0)" /> { "
  " } < use href = "#eyebrow_nose" id = "use508" width = "100%" height = "100%" x = "0" y = "0" transform = "matrix(-1 0 0 1 512.3 0)" /> { "
  " } < use href = "#pupil" id = "use510" width = "100%" height = "100%" x = "0" y = "0" transform = "translate(19.3)" /> { "
  " } < use href = "#lowpalpebra" id = "use512" width = "100%" height = "100%" x = "0" y = "0" transform = "matrix(-1 0 0 1 512.3 0)" /> { "
  ...
  " } < use href = "#loweyecontour" id = "use526" width = "100%" height = "100%" x = "0" y = "0" transform = "translate(-19.6)" /> { "
  " } < circle id = "pupil" cx = "246.3" cy = "252.1" r = "2" fill = "#85340a" style = "stroke-width:1.024" /> { "
  " } < path id = "lowpalpebra" fill = "#85340a" d = "M241 253.4c3.7 2.8 7.4 2.6 9.6 1.3 2.2-1.3 2.2-1.8 1.7-1.8-.4 0-.9.5-2.6 1.4-1.8.8-4.4.8-8.8-1z" style = "stroke-width:1.024" /> </ svg > } }