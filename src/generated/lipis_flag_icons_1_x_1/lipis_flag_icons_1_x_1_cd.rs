use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_cd (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-cd" viewBox = "0 0 512 512" > < defs > { "
    " } < clipPath id = "cd-a" > { "
      " } < path fill = "#fff" d = "M0-88h600v600H0z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g transform = "matrix(.853 0 0 .853 0 75.1)" > { "
