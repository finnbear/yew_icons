use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_bs (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-bs" viewBox = "0 0 512 512" > < defs > { "
    " } < clipPath id = "bs-a" > { "
      " } < path fill - opacity = ".7" d = "M56.6 26.4H537v480.3H56.6z" /> { "
    " } </ clipPath > { "
  " } </ defs > { "
  " } < g fill - rule = "evenodd" transform = "matrix(1.066 0 0 1.067 -60.4 -28.1)" > { "
