use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_ai (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ai" viewBox = "0 0 512 512" > < defs id = "defs1837" > { "
    " } < clipPath id = "ai-a" > { "
  ...
  " } < path id = "path6682" fill = "#c8102e" stroke - width = ".5" d = "M0 104v48h256v-48zM104 0v256h48V0z" /> </ svg > } }