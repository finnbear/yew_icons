use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_ke (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-ke" viewBox = "0 0 512 512" > < defs > { "
  ...
  " } </ g > { "
  " } < use href = "#b" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 511.7 0)" /> { "
  ...
  " } < use href = "#c" width = "100%" height = "100%" transform = "matrix(-1 0 0 1 511.7 0)" /> { "
