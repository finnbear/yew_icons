use yew :: { Callback , Html , MouseEvent } ; # [inline (never)] pub fn lipis_flag_icons_1_x_1_cefta (width : String , height : String , onclick : Option < Callback < MouseEvent >>) -> Html { yew :: html ! { < svg xmlns = "http://www.w3.org/2000/svg" data - license = "From https://github.com/lipis/flag-icons - Licensed under MIT" { width } { height } { onclick } fill = "currentColor" id = "flag-icons-cefta" version = "1.1" viewBox = "0 0 512 512" > < path id = "rect598" d = "M0 0h512v512H0z" style = "fill:#039;stroke-width:1.89893" /> { "
  ...
  " } < path id = "rect625" d = "M-22.1 524.7H7.2V554h-29.3z" style = "fill:#fc0;stroke-width:2.09407" transform = "rotate(-45)" /> </ svg > } }