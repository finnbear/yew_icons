...
function __wbg_adapter_18(arg0, arg1, arg2) {
    try {
        wasm._dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbb4b87de6e4ee235(arg0, arg1, addBorrowedObject(arg2));
    } finally {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('test-app-497810f91403ae09_bg.wasm', import.meta.url);
    }
    const imports = getImports();
